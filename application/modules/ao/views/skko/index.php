      ...
      <div class="widget-content widget-content-area br-6">
        <div class="d-flex justify-content-between">
          ...
          <div>
            ...
            <button type="button" id="addButton"  data-backdrop="static" class="btn btn-primary mb-2 mr-2" data-toggle="modal" data-target="#prkModal">
              Tambah
            </button>
            <!-- <button type="button"  data-backdrop="static" id="addButtonLanjutan" class="btn btn-warning mb-2 mr-2" data-toggle="modal" data-target="#prkModalLanjutan">
              Tambah Lanjutan
            </button> -->
          </div>
        </div>
