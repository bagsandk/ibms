      ...
      <div class="modal-body">
        <form id="prk-form">
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <label for="input-programNama">Program</label>
              <input type="text" name="programNama" class="form-control" id="input-programNama" placeholder="Program">
              <span class="e_message" style="color: #e7515a;" id="e-programNama"><span>
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
              <label for="input-fungsiNama">Fungsi</label>
              <input type="text" name="fungsiNama" class="form-control" id="input-fungsiNama" placeholder="Fungsi">
              <span class="e_message" style="color: #e7515a;" id="e-fungsiNama"><span>
            </div>
          </div>
      </div>
